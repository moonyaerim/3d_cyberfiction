...
let pogressBar = document.querySelector(".progress-bar")
let pogressText = document.querySelector(".progress-text")
let imgLoaded = 0
let imgTotal = 500;
let current = 0
let progressTimer
...
function updateProgress(){
    ...
    pogressBar.style.width = current + "%"
    pogressText.innerHTML = Math.floor(current) + "%" //Math.ceil() 소숫점 올림, Math.floor() 소숫점 내림
    //console.log(current)
